...
let proxyIP = ['proxyip.fxxk.dedyn.io','proxyip.fuck.cloudns.biz','103.200.112.108','23.162.136.169'];// 小白勿动，该地址并不影响你的网速，这是给CF代理使用的。

//let sub = '';// 留空则显示原版内容
let sub = 'http://200848a7-a9be-4546-bcc4-79b9bb10304a.cmliucdn.tk';// 内置优选订阅生成器，可自行搭建 https://github.com/cmliu/WorkerVless2sub
