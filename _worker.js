...
let proxyIP = ['cdn.xn--b6gac.eu.org','198.46.200.132','23.94.212.4','cdn-all.xn--b6gac.eu.org','edgetunnel.anycast.eu.org','103.200.112.108','23.162.136.169']; // 小白勿动，该地址并不影响你的网速，这是给CF代理使用的。'cdn.xn--b6gac.eu.org', 'cdn-all.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org'
